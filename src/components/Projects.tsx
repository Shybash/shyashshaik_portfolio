    ...
    <section id="projects" className="py-24 px-4 md:px-8 border-b border-border-subtle bg-transparent">
      <div className="max-w-7xl w-full mx-auto">
        ...
        <Tilt className="mb-16">
          <div 
            className="bg-[#0a0c24]/30 border border-white/5 rounded-xl overflow-hidden shadow-2xl spotlight-card spotlight-card-blue p-6 md:p-8 backdrop-blur-md w-full h-full"
          >
            {/* Banner */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/5 pb-6 mb-6">
              <div className="text-left">
                <div className="flex items-center space-x-2.5 mb-1.5">
                  <span className="bg-violet-500/10 text-violet-400 border border-violet-500/20 font-mono text-[9px] px-2 py-0.5 rounded font-bold uppercase tracking-wider">🤖 FLAGSHIP AI SYSTEM</span>
                  ...
                  <span className="text-zinc-550 font-mono text-[10px]">V2.0.0-PROD</span>
                </div>
                <h3 className="text-2xl font-extrabold text-white font-sans">AutoAgent: Autonomous Multi-Tool AI Agent</h3>
                <p className="text-violet-400/70 font-mono text-[10px] mt-1">Stateful ReAct Loop Engine · LangGraph · Dual-Layer Memory · Real-Time Streaming</p>
              </div>
              ...
              <div className="flex items-center space-x-3 shrink-0">
                ...
                <a href="https://github.com/Shybash" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-1.5 px-4 py-2.5 rounded-lg bg-violet-600 text-white text-xs font-bold hover:bg-violet-500 transition-colors cursor-pointer">
              ...
              <div className="lg:col-span-5 bg-zinc-950/40 border border-white/5 rounded-lg p-5 space-y-4">
                ...
                <div className="space-y-3 font-mono text-xs text-zinc-300">
                  <div className="flex justify-between border-b border-white/5 pb-2">
                    <span className="text-zinc-550 flex items-center space-x-1.5">
                      <Brain className="h-3.5 w-3.5" />
                      <span>AGENT ENGINE</span>
                    </span>
                    <span className="text-violet-300">LangGraph ReAct Loop</span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-[#0a0c24]/20 border border-white/5 p-3 rounded flex flex-col">
                    <span className="text-zinc-500 font-mono text-[9px] uppercase">Memory Recall</span>
                    <span className="text-violet-400 font-extrabold text-sm">&lt; 200ms</span>
                  </div>
                  <div className="bg-[#0a0c24]/20 border border-white/5 p-3 rounded flex flex-col">
                ...
                <div className="bg-[#0a0c24]/20 border border-white/5 p-3.5 rounded flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {additionalProjects.map((proj, idx) => (
            <Tilt key={idx} className="flex flex-col">
              <div 
                className={`bg-[#0a0c24]/30 border border-white/5 rounded-xl p-6 flex flex-col justify-between shadow-lg relative overflow-hidden spotlight-card ${proj.spotlightClass} backdrop-blur-md h-full w-full`}
              >
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 border-t border-white/5 pt-3 text-left">
                    ...
                    <div>
                      <span className="font-mono text-[9px] text-emerald-450 block uppercase font-bold">Systems Performance Gain:</span>
                ...
                <div className="border-t border-white/5 pt-4 mt-6 flex flex-wrap gap-1.5">
                  {proj.tech.map((t, i) => (
                    <span key={i} className="font-mono text-[9px] bg-zinc-950/60 border border-white/5 text-zinc-455 px-2 py-0.5 rounded">
                      {t}
                    </span>
                  ))}
                </div>
